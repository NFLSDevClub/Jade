...
public class BasicPlayer implements Player {
	...
	public BasicPlayer(Array<? extends TextureRegion> left, Array<? extends TextureRegion> center,
			...
			Array<? extends TextureRegion> toRight, Sprite hitbox, int frameLength, float radius,
		...
		this.x = Jade.screenToWorldX(Config.w / 2);
		this.y = Jade.screenToWorldY(32);
	...
	public Array<? extends TextureRegion> getLeft() {
		return left;
	}

	public void setLeft(Array<? extends TextureRegion> left) {
		this.left = left;
	}

	public Array<? extends TextureRegion> getCenter() {
		return center;
	}

	public void setCenter(Array<? extends TextureRegion> center) {
		this.center = center;
	}

	public Array<? extends TextureRegion> getRight() {
		return right;
	}

	public void setRight(Array<? extends TextureRegion> right) {
		this.right = right;
	}

	public Array<? extends TextureRegion> getToLeft() {
		return toLeft;
	}

	public void setToLeft(Array<? extends TextureRegion> toLeft) {
		this.toLeft = toLeft;
	}

	public Array<? extends TextureRegion> getToRight() {
		return toRight;
	}

	public void setToRight(Array<? extends TextureRegion> toRight) {
		this.toRight = toRight;
	}
	...
	public void setHitbox(Sprite hitbox) {
		this.hitbox = hitbox;
	}
}
